...
try:
    os.system('clear')
    print("PLEASE WAIT UNTIL THE PROCESS IS DONE")
...
def approval():
    ...
    try:
        ...
        clear()
        print("You Need Approval To Use This Tool   \033[1;37m")
        print("I ain't responsible if anything happens while you try to bypass.  \033[1;37m")
        print(f" Your Key :\u001b[36m {key}")
        linex()
...
def setup_user_data():
    ...
    upass = get_user_input("data/passwordaq.xml", f" MAKE A PASSWORD ")
...
def menu():
    ...
    print("│   ENTER 1 TO CHOOSE METHOD TO ADD ACCOUNTS       │")
    print("│   ENTER 2 TO REACT ON POST                       │")
    print("│   ENTER 3 TO COMMENT ON POST                     │")
    ...
    menu_actions = {
        ...
        '2': QuickReact,
        '5': C_page,
        '0': lambda: print(f"{red} Before following get token first .{r}"),
        '3': comment_on_facebook_post,
        '6': AutomaticSharing,
        '7': lambda: reset(),
        '4': lambda: print('LOGED OUT') or exit()
    }
    menu_actions.get(choice, lambda: print('CHOOSE ONLY FROM 1 TO 4'))()
